...
# Run the line below with no changes to check that you've loaded the input correctly

# Fill in the line below: In the first five rows of the input, what is the
...
# ['Radius (mean)']
print('3' * 100)
# sns.histplot(input=cancer_data, x='Area (mean)', hue='Diagnosis')
print('4' * 100)
